...
/**
 * AuditLogService — تسجيل واسترجاع أحداث Audit.
 *
 * يُستدعى من أي مكان في الـ Backend لتسجيل حدث:
 *   auditLogService.log(AuditType.TERMINAL, "Command executed: ss -tn", "web-server");
 */
@Service
