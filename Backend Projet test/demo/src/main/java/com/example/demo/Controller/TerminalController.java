...
public class TerminalController {
    ...
    /**
     * Whitelist بسيط للـ commands الخطيرة.
     */
    ...
    /**
     * POST /api/terminal/exec
     * Body: { "device": "web-server", "command": "uname -a" }
     */
    @PostMapping("/exec")
    public ResponseEntity<Map<String, Object>> executeCommand(
        ...
        // Backward compatibility: لو frontend قديم يرسل "container" بدل "device"
        if (device == null && request.containsKey("container")) {
            String containerName = request.get("container");
            // امسح الـ prefix لو موجود
